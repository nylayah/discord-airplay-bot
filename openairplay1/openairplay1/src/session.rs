...
impl Session {
    ...
    pub async fn handle_setup(&mut self, request: &Request, local_ip: IpAddr) -> Response {
        ...
        debug!("SETUP local_ip={local_ip}, peer_ip={}", self.peer_ip);

        // Use IPv4 for the RTP/timing/control UDP sockets.
        // macOS link-local IPv6 addresses require a scope ID (e.g. %14),
        // which this socket-binding path does not preserve.
